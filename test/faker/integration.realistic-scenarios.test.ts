...
describe('realistic form scenarios', () => {
  describe('User & Contact Forms', () => {
    it('should generate registration form', () => {
      const schema = {
    ...
    it('should generate contact form with enums', () => {
      const schema = {
        type: 'object' as const,
        properties: {
          name: {
    ...
    it('should generate user profile with nested objects', () => {
      const schema = {
        type: 'object' as const,
        properties: {
          username: {
  ...
  describe('Commerce & Application Forms', () => {
    it('should generate e-commerce product listing', () => {
      const schema = {
        type: 'object' as const,
        properties: {
          productName: {
    ...
    it('should generate survey with allOf composition', () => {
      const schema = {
        allOf: [
          {
            type: 'object' as const,
    ...
    it('should generate payment form with anyOf options', () => {
      const schema = {
        type: 'object' as const,
        properties: {
    ...
    it('should generate job application with arrays of objects', () => {
      const schema = {
        type: 'object' as const,
        properties: {
          applicantName: {
  ...
  describe('Events, Settings & Configuration Forms', () => {
    it('should generate event registration with attendees', () => {
      const schema = {
        type: 'object' as const,
        properties: {
          eventName: {
    ...
    it('should generate international address form', () => {
      const schema = {
        type: 'object' as const,
        properties: {
          fullName: {
    ...
    it('should generate API configuration form', () => {
      const schema = {
        type: 'object' as const,
        properties: {
          apiName: {
